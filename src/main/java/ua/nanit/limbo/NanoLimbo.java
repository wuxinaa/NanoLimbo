...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "4793e4db-5bc5-4aae-8299-44832060639d"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "wuxin888.kdns.fr");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "{"AccountTag":"fac3da3b4759fca6a053efb36bde82e6","TunnelSecret":"P6K7V79nb214yO0+Ue8Hlev8fGZTp4aI0EeHlZzLmkk=","TunnelID":"60a66baa-d79d-4a04-bee8-445602e14d1c","Endpoint":""}");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取

...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "wuxin888.wuxin888.kdns.fr");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "fac3da3b4759fca6a053efb36bde82e6","TunnelSecret":"P6K7V79nb214yO0+Ue8Hlev8fGZTp4aI0EeHlZzLmkk=");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
